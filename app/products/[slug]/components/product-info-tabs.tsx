          ...
          <div className='space-y-4 text-foreground '>
            <div>
              ...
              <p className='text-muted-foreground'>
                We offer free shipping on orders over $50. Standard shipping takes 5-7 business days. Express shipping (2-3 days) is
            ...
            <div>
              ...
              <p className='text-muted-foreground'>
                We offer a 30-day money-back guarantee. Items must be in original condition with all packaging and accessories. Return
            ...
            {faqs.map(faq => (
              <div key={faq.id} className='border border-border rounded-lg overflow-hidden'>
                ...
                >
                  ...
                  <ChevronDown
                    size={20}
                    className={`flex-shrink-0 text-muted-foreground transition-transform ${expandedFaq === faq.id ? 'rotate-180' : ''}`}
                  />
                </button>
                {expandedFaq === faq.id && (
