	...
	return (
		<>
			...
			<div className={styles.mainWrapper}>
				<IoCloseCircle onClick={closeModal} color="black" className="absolute top-4 right-4 z-[9999]" size={30} />
				...
				<div>
					...
					<ListAnswers className="!mt-0" answers={SHIPPING_ANSWERS?.map(q => `For ${q}`).concat(SHIPPING_MODAL)} />
