...
import React, { FC, memo, useRef, useState, useTransition } from 'react'
...
const Address: FC<Props> = ({ address, openEditModal }) => {
			...
			<CardBody>
				<div className="flex justify-between items-start">
					...
					<div className="flex gap-2">
						<Button isIconOnly size="sm" variant="light" aria-label="Edit address" onPress={openEditModal}>
