...
import { PAYMENT_METHODS, TAGS } from '@/constants'
...
const AddEditPaymentMethods: FC<Props> = ({ isOpen, onOpenChange, displayDefault, data }) => {
							...
							<Form action={action} validationErrors={state?.errors} onSubmit={handleSubmit} ref={formRef}>
								...
								>
									{payment => (
										<SelectItem
											key={payment.key}
											textValue={payment.label}
											isDisabled={data?.some(method => method.type === payment.key)}
										>
